...
```mermaid
graph LR
    A["🌱 YEAR 1<br/>Build the base<br/><br/>1 language<br/>Basic DSA<br/>Git + Linux"]
    B["🔨 YEAR 2<br/>Pick your track<br/><br/>DSA patterns<br/>First real project<br/>CS fundamentals"]
    C["🚀 YEAR 3<br/>Prove it<br/><br/>Internship<br/>2 strong projects<br/>Resume + LinkedIn"]
    D["🎯 YEAR 4<br/>Convert<br/><br/>Apply everywhere<br/>Interviews<br/>Offer in hand"]
...
```mermaid
graph TD
    S["🟢 LEVEL 1 — Service<br/>TCS, Infosys, Wipro, Cognizant, Accenture, Capgemini, LTIMindtree<br/>₹3.5–7 LPA · Aptitude-heavy · Mass hiring · Your safety net"]
    M["🔵 LEVEL 2 — Mid Product & Startups<br/>Zoho, Freshworks, Josh Tech, Nagarro, Publicis Sapient, funded startups<br/>₹6–15 LPA · Real DSA + projects · Very achievable from tier-3"]
    P["🟣 LEVEL 3 — Strong Product<br/>Razorpay, Zomato, Swiggy, PhonePe, Groww, Postman, Zeta, Sprinklr<br/>₹15–30 LPA · Hard DSA + system design · Needs 2+ yrs prep or referral"]
    F["🔴 LEVEL 4 — FAANG & Equivalent<br/>Google, Amazon, Microsoft, Atlassian, Adobe, Uber, Salesforce, DE Shaw<br/>₹25–60 LPA · Elite DSA · Off-campus only · Possible, not probable"]

    S --> M --> P --> F

    style S fill:#065f46,stroke:#10b981,color:#fff
    style M fill:#1e40af,stroke:#3b82f6,color:#fff
    style P fill:#6d28d9,stroke:#a78bfa,color:#fff
